...
let arr = [
  {
    class: "",
    key: 0,
    itemText: ['Пункт 1','Пункт 2','Пункт 3'],
    color: 'rgba(250,30,30,0.1)',
  ...
  },
  {
    class: "",
    key: 1,
    itemText: ['Пункт 4','Пункт 5','Пункт 3'],
    color: 'rgba(150,30,100,0.1)',
        ...
        {/* <ToDoItem key={1} initText={"item 1"} /> */}
         {
          this.state.array.map((item) => {
            return <Square key={item.key} imgSrc={item.icon} todos={item.itemText} color={item.color}  id={item.key} clickFunction={this.deactive} />
          })
        }
